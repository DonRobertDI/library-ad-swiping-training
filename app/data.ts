...
export const steps: Step[] = [
  ...
  },
  {
    ...
    instructions: [
      "Keywords are created by Generate preview and are the broadest source.",
  ...
  {
    number: 9,
    title: "Prioritize the strongest sources",
    instructions: [
      "Use this order: Product names, Swipe domains/Facebook Pages, then Keywords.",
      "The first three sources are more likely to return the exact product or strongly relevant ads.",
      "Use Keywords only as a last resort when the other sources do not return enough ads.",
      "Keyword results are broader and require slower one-by-one relevance checks.",
    ],
    figures: [
      { number: 26, caption: "Product names are the first source to scrape" },
      { number: 27, caption: "Swipe domains usually return highly relevant ads" },
      { number: 28, caption: "Facebook Pages are another strong source" },
    ],
  },
  {
    number: 10,
    ...
    instructions: [
      ...
      "Use Approve to keep a useful on-niche ad in the Library without attaching it to the product.",
    ...
    figures: [
      { number: 29, caption: "Filter Pending review by the winning product" },
      { number: 30, caption: "Use Approve, Approve to Product, or Reject" },
      { number: 31, caption: "Decision guide for Discovery review actions" },
    ],
  },
  {
    number: 11,
    ...
    figures: [{ number: 32, caption: "Select approved Winner Ads for localization" }],
  },
  {
    number: 12,
    ...
    figures: [
      { number: 33, caption: "Mark competitor branding before localization when needed" },
      { number: 34, caption: "Choose the target language and market" },
      { number: 35, caption: "Compare the original and localized ad and apply fixes" },
      { number: 36, caption: "Use the percent-off badge setting for a consistent discount" },
    ],
  ...
  },
  {
    ...
    figures: [
      { number: 37, caption: "Retag the newly added funnel in Swipe Sources" },
      { number: 38, caption: "Search and group only visually matching products in Funnels" },
    ],
  },
];
...
export const checklist = [
  ...
  "Keywords were used only if the stronger sources were insufficient.",
